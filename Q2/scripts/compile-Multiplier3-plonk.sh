...
# [assignment] create your own bash script to compile Multiplier3.circom using PLONK below#!/bin/bash
...
# snarkjs zkey contribute HelloWorld/circuit_0000.zkey Multiplier3/circuit_final.zkey --name="1st Contributor Name" -v -e="random text"
